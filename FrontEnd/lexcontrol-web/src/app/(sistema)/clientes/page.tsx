          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start justify-between pb-4 border-b border-slate-800">
              ...
              <div className={`px-4 py-1.5 rounded-full text-xs font-bold border flex items-center gap-2 ${
                selectedCliente.statusPagamento === 'PAGO' 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* 2. DADOS PESSOAIS (CPF, RG, Telefone) */}
              ...
              {/* 3. FINANCEIRO & PROCESSO (Valores, Datas, Modelo) */}
              <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                   ...
                   <div className="grid grid-cols-2 gap-2 pt-1">
                      ...
                      {/* Mostra valor da parcela apenas se for Parcelado */}
              ...
              {/* 4. ENDEREÇO (Ocupa as 2 colunas se existir) */}
